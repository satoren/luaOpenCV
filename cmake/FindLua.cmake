...
if(LOCAL_LUA_DIRECTORY)
  ...
  if(EXISTS ${CMAKE_CURRENT_SOURCE_DIR}/${LOCAL_LUA_DIRECTORY})
    file(COPY ${CMAKE_CURRENT_SOURCE_DIR}/Lua-CMakeLists.txt DESTINATION ${CMAKE_CURRENT_SOURCE_DIR}/${LOCAL_LUA_DIRECTORY})
    ...
    add_subdirectory(${CMAKE_CURRENT_SOURCE_DIR}/${LOCAL_LUA_DIRECTORY})
